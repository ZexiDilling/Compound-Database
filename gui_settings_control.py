        ...
        while True:
            ...
            if event == "-BIO_SETTINGS_OK-":
                ...
                bio_final_report_setup = {
                    ...
                    "full_report_matrix": {"sample": values["-FINAL_REPORT_MATRIX_sample-"],
                                           "minimum": values["-FINAL_REPORT_MATRIX_minimum-"],
                                           "max": values["-FINAL_REPORT_MATRIX_max-"],
                                           "empty": values["-FINAL_REPORT_MATRIX_empty-"],
                                           "negative control": values["-FINAL_REPORT_MATRIX_negative-"],
                                           "positive control": values["-FINAL_REPORT_MATRIX_positive-"],
                                           "blank": values["-FINAL_REPORT_MATRIX_blank-"],
                                           "z_prime": values["-FINAL_REPORT_MATRIX_z_prime-"]}
                }
                ...
                bio_plate_report_setup = {
                    ...
                    "plate_report_calc_dict":
                        {"original": {"use": values["-BIO_REPORT_SHEET_ORG_CALC-"],
                         ...
                         "other_data": {"use": values["-BIO_REPORT_SHEET_OTHER-"],
